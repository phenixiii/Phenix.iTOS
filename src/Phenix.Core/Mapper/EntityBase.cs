...
namespace Phenix.Core.Mapper
{
        ...
        where T : EntityBase<T>
    {
        ...
        public static T New(params NameValue<T>[] propertyValues)
        {
            return New(Database.Default, NameValue<T>.ToDictionary(propertyValues));
        }
        ...
        /// <param name="propertyValues">待更新属性值队列(如果没有set语句的话就直接更新字段)</param>
        /// <returns>实体对象</returns>
        public static T New(IDictionary<string, object> propertyValues)
        {
            return New(Database.Default, propertyValues);
        }
        ...
        {
            T result = (T)_create();
            result.Database = database ?? Database.Default;
        ...
        /// <param name="propertyValues">待更新属性值队列(如果没有set语句的话就直接更新字段)</param>
        /// <returns>实体对象</returns>
        public static T New(long primaryKeyLong, params NameValue<T>[] propertyValues)
        {
            return New(Database.Default, primaryKeyLong, NameValue<T>.ToDictionary(propertyValues));
        }
        ...
        /// <param name="propertyValues">待更新属性值队列(如果没有set语句的话就直接更新字段)</param>
        /// <returns>实体对象</returns>
        public static T New(long primaryKeyLong, IDictionary<string, object> propertyValues)
        {
            return New(Database.Default, primaryKeyLong, propertyValues);
        }
        ...
        public static T FetchRoot(Expression<Func<T, bool>> criteriaLambda, Func<T> doCreate = null)
        {
            return FetchRoot(Database.Default, CriteriaExpression.Where(criteriaLambda), null, doCreate);
        }
        ...
        /// <param name="doCreate">如果没有该条件的实体对象则调用本函数新增并自动持久化</param>
        /// <returns>根实体对象</returns>
        public static T FetchRoot(Expression<Func<T, bool>> criteriaLambda, object criteria, Func<T> doCreate = null)
        {
            return FetchRoot(Database.Default, CriteriaExpression.Where(criteriaLambda), criteria, doCreate);
        }
        ...
        /// <param name="doCreate">如果没有该条件的实体对象则调用本函数新增并自动持久化</param>
        /// <returns>根实体对象</returns>
        public static T FetchRoot(CriteriaExpression criteriaExpression, Func<T> doCreate = null)
        {
            return FetchRoot(Database.Default, criteriaExpression, null, doCreate);
        }
        ...
        /// <param name="doCreate">如果没有该条件的实体对象则调用本函数新增并自动持久化</param>
        /// <returns>根实体对象</returns>
        public static T FetchRoot(CriteriaExpression criteriaExpression, object criteria, Func<T> doCreate = null)
        {
            return FetchRoot(Database.Default, criteriaExpression, criteria, doCreate);
        }
        ...
        /// <returns>根实体对象</returns>
        public static T FetchRoot(Expression<Func<T, bool>> criteriaLambda, params OrderBy<T>[] orderBys)
        {
            return FetchRoot(Database.Default, CriteriaExpression.Where(criteriaLambda), null, orderBys);
        }
        ...
        /// <param name="orderBys">排序队列</param>
        /// <returns>根实体对象</returns>
        public static T FetchRoot(Expression<Func<T, bool>> criteriaLambda, object criteria, params OrderBy<T>[] orderBys)
        {
            return FetchRoot(Database.Default, CriteriaExpression.Where(criteriaLambda), criteria, orderBys);
        }
        ...
        /// <param name="orderBys">排序队列</param>
        /// <returns>根实体对象</returns>
        public static T FetchRoot(CriteriaExpression criteriaExpression, params OrderBy<T>[] orderBys)
        {
            return FetchRoot(Database.Default, criteriaExpression, null, orderBys);
        }
        ...
        /// <param name="orderBys">排序队列</param>
        /// <returns>根实体对象</returns>
        public static T FetchRoot(CriteriaExpression criteriaExpression, object criteria, params OrderBy<T>[] orderBys)
        {
            return FetchRoot(Database.Default, criteriaExpression, criteria, orderBys);
        }
        ...
        /// <param name="criteriaLambda">条件表达式</param>
        /// <param name="criteria">条件对象/JSON格式字符串/属性值队列</param>
        public static IDictionary<TKey, T> FetchKeyValues<TKey>(Expression<Func<T, TKey>> keyLambda, Expression<Func<T, bool>> criteriaLambda = null, object criteria = null)
        {
            return FetchKeyValues(Database.Default, keyLambda, CriteriaExpression.Where(criteriaLambda), criteria);
        }
        ...
        /// <param name="criteriaExpression">条件表达式</param>
        /// <param name="criteria">条件对象/JSON格式字符串/属性值队列</param>
        public static IDictionary<TKey, T> FetchKeyValues<TKey>(Expression<Func<T, TKey>> keyLambda, CriteriaExpression criteriaExpression, object criteria = null)
        {
            return FetchKeyValues(Database.Default, keyLambda, criteriaExpression, criteria);
        }
        ...
        /// </summary>
        /// <param name="orderBys">排序队列</param>
        public static IList<T> FetchList(params OrderBy<T>[] orderBys)
        {
            return FetchList(Database.Default, (CriteriaExpression)null, null, orderBys);
        }
        ...
        /// <param name="criteriaLambda">条件表达式</param>
        /// <param name="orderBys">排序队列</param>
        public static IList<T> FetchList(Expression<Func<T, bool>> criteriaLambda, params OrderBy<T>[] orderBys)
        {
            return FetchList(Database.Default, CriteriaExpression.Where(criteriaLambda), null, orderBys);
        }
        ...
        /// <param name="criteria">条件对象/JSON格式字符串/属性值队列</param>
        /// <param name="orderBys">排序队列</param>
        public static IList<T> FetchList(Expression<Func<T, bool>> criteriaLambda, object criteria, params OrderBy<T>[] orderBys)
        {
            return FetchList(Database.Default, CriteriaExpression.Where(criteriaLambda), criteria, orderBys);
        }
        ...
        /// <param name="criteriaExpression">条件表达式</param>
        /// <param name="orderBys">排序队列</param>
        public static IList<T> FetchList(CriteriaExpression criteriaExpression, params OrderBy<T>[] orderBys)
        {
            return FetchList(Database.Default, criteriaExpression, null, orderBys);
        }
        ...
        /// <param name="criteria">条件对象/JSON格式字符串/属性值队列</param>
        /// <param name="orderBys">排序队列</param>
        public static IList<T> FetchList(CriteriaExpression criteriaExpression, object criteria, params OrderBy<T>[] orderBys)
        {
            return FetchList(Database.Default, criteriaExpression, criteria, orderBys);
        }
        ...
        public int DeleteDetails<TDetail>(Expression<Func<TDetail, bool>> criteriaLambda = null, object criteria = null)
            where TDetail : EntityBase<TDetail>
        {
        ...
        /// <param name="criteria">条件对象/JSON格式字符串/属性值队列</param>
        /// <returns>删除记录数</returns>
        public int DeleteDetails<TDetail>(DbConnection connection, Expression<Func<TDetail, bool>> criteriaLambda = null, object criteria = null)
            where TDetail : EntityBase<TDetail>
        {
        ...
        /// <param name="criteria">条件对象/JSON格式字符串/属性值队列</param>
        /// <returns>删除记录数</returns>
        public int DeleteDetails<TDetail>(DbTransaction transaction, Expression<Func<TDetail, bool>> criteriaLambda = null, object criteria = null)
            where TDetail : EntityBase<TDetail>
        {
