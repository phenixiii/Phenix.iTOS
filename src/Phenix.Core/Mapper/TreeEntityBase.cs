...
namespace Phenix.Core.Mapper
{
        ...
        where T : TreeEntityBase<T>
    {
        ...
        public static T NewRoot(params NameValue<T>[] propertyValues)
        {
            return NewRoot(Database.Default, NameValue<T>.ToDictionary(propertyValues));
        }
        ...
        /// <param name="propertyValues">待更新属性值队列(如果没有set语句的话就直接更新字段)</param>
        /// <returns>根实体对象</returns>
        public static T NewRoot(IDictionary<string, object> propertyValues)
        {
            return NewRoot(Database.Default, propertyValues);
        }
        ...
        /// <param name="propertyValues">待更新属性值队列(如果没有set语句的话就直接更新字段)</param>
        /// <returns>根实体对象</returns>
        public static T NewRoot(long id, params NameValue<T>[] propertyValues)
        {
            return NewRoot(Database.Default, id, NameValue<T>.ToDictionary(propertyValues));
        }
        ...
        /// <param name="propertyValues">待更新属性值队列(如果没有set语句的话就直接更新字段)</param>
        /// <returns>根实体对象</returns>
        public static T NewRoot(long id, IDictionary<string, object> propertyValues)
        {
            return NewRoot(Database.Default, id, propertyValues);
        }
        ...
        /// <returns>根实体对象</returns>
        public static T FetchTree(Expression<Func<T, bool>> criteriaLambda, Func<T> doCreate = null)
        {
            return FillAllChildren(FetchRoot(criteriaLambda, doCreate));
        }
        ...
        /// <param name="doCreate">如果没有该条件的实体对象则调用本函数新增并自动持久化</param>
        /// <returns>根实体对象</returns>
        public static T FetchTree(Expression<Func<T, bool>> criteriaLambda, object criteria, Func<T> doCreate = null)
        {
            return FillAllChildren(FetchRoot(criteriaLambda, criteria, doCreate));
        }
        ...
        /// <param name="doCreate">如果没有该条件的实体对象则调用本函数新增并自动持久化</param>
        /// <returns>根实体对象</returns>
        public static T FetchTree(CriteriaExpression criteriaExpression, Func<T> doCreate = null)
        {
            return FillAllChildren(FetchRoot(criteriaExpression, doCreate));
        }
        ...
        /// <param name="doCreate">如果没有该条件的实体对象则调用本函数新增并自动持久化</param>
        /// <returns>根实体对象</returns>
        public static T FetchTree(CriteriaExpression criteriaExpression, object criteria, Func<T> doCreate = null)
        {
            return FillAllChildren(FetchRoot(criteriaExpression, criteria, doCreate));
        }
        ...
        /// <returns>根实体对象</returns>
        public static T FetchTree(Expression<Func<T, bool>> criteriaLambda, params OrderBy<T>[] orderBys)
        {
            return FillAllChildren(FetchRoot(criteriaLambda, orderBys));
        }
        ...
        /// <param name="orderBys">排序队列</param>
        /// <returns>根实体对象</returns>
        public static T FetchTree(Expression<Func<T, bool>> criteriaLambda, object criteria, params OrderBy<T>[] orderBys)
        {
            return FillAllChildren(FetchRoot(criteriaLambda, criteria, orderBys));
        }
        ...
        /// <param name="orderBys">排序队列</param>
        /// <returns>根实体对象</returns>
        public static T FetchTree(CriteriaExpression criteriaExpression, params OrderBy<T>[] orderBys)
        {
            return FillAllChildren(FetchRoot(criteriaExpression, orderBys));
        }
        ...
        /// <param name="orderBys">排序队列</param>
        /// <returns>根实体对象</returns>
        public static T FetchTree(CriteriaExpression criteriaExpression, object criteria, params OrderBy<T>[] orderBys)
        {
            return FillAllChildren(FetchRoot(criteriaExpression, criteria, orderBys));
        }
